...
for x in range(1,17):
    ...
    try:
        download_cmi(data_hora_download_file, x, dir_in + f'band{b}', logging)
    except:
        continue
...
#Download RRQPEF
logging.info("")
logging.info(f'Tentando download RRQPEF...')
try:
    download_prod(data_hora_download_file,'ABI-L2-RRQPEF',dir_in+'rrqpef/', logging)
except:
    pass
...
try:
    download_prod(data_hora_download_file,"ABI-L2-FDCF",dir_in +'fdcf/', logging)
except:
    pass
